...
| ------ | --------------------------------------------------------------- | -------------------------------------------------------------- | -------- |
| **S0** | Deep teardown docs + roadmap này + cập nhật matrix/HANDOVER     | (docs only)                                                    | (sẽ ghi) |
| **S1** | PGN import/export + chapter orientation / description / pgnTags | `docs/specs/chess-study-pgn-and-chapter-meta-business-spec.md` |          |
