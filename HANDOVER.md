...
**Việc cần làm tiếp:** verify + commit + push + tạo PR + merge Đợt 6, rồi tiếp tục Đợt 7 (cộng đồng + hồ sơ công khai) theo đúng `docs/research/learnhouse/05-roadmap.md`.
