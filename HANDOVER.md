...
**Việc cần làm tiếp:** verify + commit + push + tạo PR + merge Đợt 4, rồi tiếp tục Đợt 5 (analytics sâu phần 2: cohort retention, heatmap giờ cao điểm, DAU trend...) theo đúng `docs/research/learnhouse/05-roadmap.md`.
