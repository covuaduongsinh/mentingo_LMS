...
**Việc cần làm tiếp:** verify + commit + push + tạo PR + merge Đợt 8, rồi tiếp tục Đợt 9 (webhook đi ra + tự động hóa) theo đúng `docs/research/learnhouse/05-roadmap.md`.
