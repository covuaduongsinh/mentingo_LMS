...
**Việc cần làm tiếp:** verify + commit + push + tạo PR + merge Đợt 11. Sau đó, các hạng mục còn lại: 7 hạng mục "vận hành & tuân thủ" gốc của Đợt 10 (custom domain, menu builder, landing page builder, custom scripts, đồng tác giả khóa học, khóa bài học theo nhóm, xuất user CSV, SEO mặc định theo tenant) vẫn còn trong `docs/research/learnhouse/05-roadmap.md` như các đợt tiềm năng cho tương lai, nếu có nhu cầu. Follow-up Work riêng của Đợt 11 (presence/con trỏ chuột, chat trong phòng, log tham gia chi tiết, chuyển quyền host, danh sách phòng đang hoạt động) cũng có thể triển khai sau nếu cần.
