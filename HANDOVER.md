...
**Việc cần làm tiếp:** verify + commit + push + tạo PR + merge Đợt 3, rồi tiếp tục Đợt 4 (lịch sử phiên bản nội dung bài học) theo đúng `docs/research/learnhouse/05-roadmap.md`.
