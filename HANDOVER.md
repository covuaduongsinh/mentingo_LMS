...
| **Đợt 7**       | _(xem mục dưới)_ | Diễn đàn cộng đồng (thu hẹp phạm vi) + hồ sơ công khai `/u/:username`: bài đăng/bình luận 1 cấp/upvote, kiểm duyệt (từ chặn + giới hạn bài/ngày), username + bio opt-in công khai. Reaction emoji/slow-mode/tự khóa/yêu cầu email xác minh hoãn sang Follow-up. Spec: `docs/specs/community-forum-business-spec.md`.                                        |
...
**Việc cần làm tiếp:** verify + commit + push + tạo PR + merge Đợt 7, rồi tiếp tục Đợt 8 (thư viện phân cấp + bàn phân tích cờ cộng tác) theo đúng `docs/research/learnhouse/05-roadmap.md`.
