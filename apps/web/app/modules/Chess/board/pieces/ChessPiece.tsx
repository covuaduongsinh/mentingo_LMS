/**
 * Staunton-style SVG chess pieces (in-repo, MIT-compatible original paths).
 * ViewBox 0 0 45 45 — classic scale used by many open chess UIs.
 */
...
function BlackQueen() {
  return (
    <g fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinejoin="round">
      <g stroke="none">
...
export function ChessPiece({ color, type, size = "100%", className }: ChessPieceProps) {
  const key = `${color}${type}` as keyof typeof PIECE_MAP;
  const Piece = PIECE_MAP[key];
